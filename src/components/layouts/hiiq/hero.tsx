	...
	return (
		<section className="relative isolate overflow-hidden">
			...
			<Container className="max-w-[880px] pb-20 pt-32 text-center sm:pt-40">
				...
				<p className="mx-auto mt-6 max-w-[34rem] text-[15px] leading-relaxed text-neutral-400 text-pretty">
					{t("description")}
				</p>
				...
				<div className="mt-11 flex flex-wrap items-center justify-center gap-2">
					{CHIPS.map((chip) => (
						<span
							key={chip}
							className="rounded-lg border border-rule-control bg-surface-raised px-3.5 py-2 font-mono text-xs text-neutral-400"
						>
							{t.rich(`chips.${chip}`, {
