...
import { ibmPlexMono, instrumentSerif, montserrat, satoshi } from "../font";
...
export default async function RootLayout({
	...
	return (
		<html
			lang={locale}
			className={`${montserrat.className} ${ibmPlexMono.variable} ${satoshi.variable} ${instrumentSerif.variable}`}
		>
			<head>
				<link rel="canonical" />
